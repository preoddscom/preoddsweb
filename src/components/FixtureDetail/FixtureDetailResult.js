...
const FixtureDetailResult = props => {
  ...
  return fixtureDetail.timeStatus === "NS" ||
    ...
    <div className="d-flex flex-column justify-content-start  text-white w-25">
      ...
      <div className="align-self-center" style={{ fontSize: "16px" }}>
        VS
      </div>
      <div className="align-self-center">
    ...
    <div className="d-flex flex-column w-25 pt-2 text-white">
      ...
      <div className="align-self-center">
        <span className="badge badge-dark" style={{ fontSize: "14px" }}>
    ...
    <div className="d-flex flex-column w-25 pt-2 text-white">
      <div className="align-self-center" style={{ fontSize: "20px" }}>
        {fixtureDetail.timeStatus === "PEN_LIVE" ? (
...
export default FixtureDetailResult;
