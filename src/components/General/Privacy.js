...
const Privacy = () => {
  return (
    <div>
      ...
      <p>
        PreOdds ("us", "we", or "our") operates the https://www.preodds.com
        website and the PreOdds mobile application (the "Service").
      </p>
      ...
      <p>PreOdds uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside Turkey and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Turkey and process it there.
      </p>
      <p>
      ...
      <p>
        PreOdds will take all steps reasonably necessary to ensure that your
      ...
      <p>
        PreOdds may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of PreOdds</li>
        <li>
      ...
      <ul>
        <li>By email: info@preodds.com</li>
        <li>
          By visiting this page on our website:
          https://www.preodds.com/PreOdds/Contact
        </li>
      </ul>
    </div>
  );
