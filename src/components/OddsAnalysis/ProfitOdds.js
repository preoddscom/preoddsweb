...
import ProfitOddSearchBar from "./ProfitOddSearchBar";
...
class ProfitOdds extends Component {
  state = {
    oddAnalysisArray: [],
    analysisPeriod: 0,
    selectedMarket: 1,
  ...
  fetchAnalysis = (
    ...
    fetch(
      `${
        Util.API_URL
      }earningPercenteFixtures/2/${marketId}/date=${selectedDate}&c=${analysisPeriod}&minRate=${minRateInput}&af=${fixtureState}&page=${page}&lang=${
        this.props.lang
